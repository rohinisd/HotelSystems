-- SFMS Database Schema
-- Multi-tenant sports facility management system
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_booking_facility_date ON booking(facility_id, date);
CREATE INDEX IF NOT EXISTS idx_booking_court_date ON booking(court_id, date);
CREATE INDEX IF NOT EXISTS idx_booking_player ON booking(player_id);
CREATE INDEX IF NOT EXISTS idx_court_branch ON court(branch_id);
CREATE INDEX IF NOT EXISTS idx_court_facility ON court(facility_id);
...
CREATE INDEX IF NOT EXISTS idx_pricing_court ON pricing_rule(court_id);
CREATE INDEX IF NOT EXISTS idx_branch_facility ON branch(facility_id);

-- Exclusion constraint to prevent double-booking at DB level
